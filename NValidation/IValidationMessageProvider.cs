namespace NValidation
{
    ...
    /// the application's resources: the core knows only the keys in <see cref="ValidationErrorCodes"/>,
    /// while the host decides where the texts come from and in which language.
    /// </summary>
    public interface IValidationMessageProvider
    {
        /// <summary>
        /// Returns the message for <paramref name="errorCode"/>, with the named placeholders of
